...
<div class="relative shadow-md sm:rounded-lg w-3/4">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
        ...
        <tr class="bg-white border-b border-gray-200 hover:bg-gray-50 ">
            ...
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div> {{ $user->email_verified_at ?? 'Not verified'}}
                </div>
            </td>
            <td class="px-6 py-4">
                <a href="{{ route('admin.users.edit', ['id'=> $user->id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
            </td>
        </tr>
        @endforeach
        </tbody>
